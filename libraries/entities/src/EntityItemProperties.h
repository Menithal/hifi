...
public:
    ...
    DEFINE_PROPERTY(PROP_MAXIMUM_AVATAR_VELOCITY, MaximumAvatarVelocity, maximumAvatarVelocity, float, ZoneEntityItem::DEFAULT_MAXIMUM_AVATAR_VELOCITY);
...
inline QDebug operator<<(QDebug debug, const EntityItemProperties& properties) {
    ...
    DEBUG_PROPERTY_IF_CHANGED(debug, properties, MaximumAvatarVelocity, maximumAvatarVelocity, "");
